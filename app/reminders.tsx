...
const ReminderApp: React.FC = () => {
  ...
  const { expandOpen, expandCompleted } = route.params as RouteParams || {};
  ...
  useEffect(() => {
    if (expandOpen !== undefined) setRemindersExpanded(expandOpen);
    if (expandCompleted !== undefined) setCompletedExpanded(expandCompleted);
  }, [expandOpen, expandCompleted]);
          ...
          if (completedItem) {
            ...
            if (completedItem.notificationId) {
              try {
                ...
                completedItem.notificationId = undefined;
